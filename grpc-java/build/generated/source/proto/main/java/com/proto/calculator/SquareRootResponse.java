...
private static final long serialVersionUID = 0L;
  ...
  public static final int ROOT_NUMBER_FIELD_NUMBER = 1;
  private double rootNumber_;
  /**
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (rootNumber_ != 0D) {
      output.writeDouble(1, rootNumber_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (rootNumber_ != 0D) {
      size += com.google.protobuf.CodedOutputStream
        .computeDoubleSize(1, rootNumber_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (java.lang.Double.doubleToLongBits(getRootNumber())
        != java.lang.Double.doubleToLongBits(
            other.getRootNumber())) return false;
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + ROOT_NUMBER_FIELD_NUMBER;
    hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
        java.lang.Double.doubleToLongBits(getRootNumber()));
  ...
  public static final class Builder extends
    ...
    public com.proto.calculator.SquareRootResponse buildPartial() {
      ...
      result.rootNumber_ = rootNumber_;
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(com.proto.calculator.SquareRootResponse other) {
      ...
      if (other.getRootNumber() != 0D) {
        setRootNumber(other.getRootNumber());
      }
    ...
    /**
     * <code>double root_number = 1;</code>
     * @param value The rootNumber to set.
     * @return This builder for chaining.
     */
    public Builder setRootNumber(double value) {
